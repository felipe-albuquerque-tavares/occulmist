...
export function processGameUpdate(update) {
  ...
  updateInventory(update.me.inventory,update.me.item_selected);
...
export function getCurrentState() {
  ...
  if (base < 0 || base === gameUpdates.length - 1) {
    ...
    return {
      ...
      enemys: interpolateObjectArray(baseUpdate.enemys, next.enemys, ratio),
      // inventory: baseUpdate.me.inventory,
    };
  }
}
